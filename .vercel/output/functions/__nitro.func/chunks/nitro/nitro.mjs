...
const _sQDgxcqDrsUayDnnr6AZ_sMq3KWIazT3po6jbSTGEgg = (function(nitro) {
...
const plugins = [
  _sQDgxcqDrsUayDnnr6AZ_sMq3KWIazT3po6jbSTGEgg
];
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "72a119a4-7a51-494b-ab85-3856a44aaa14",
...
const _qxbQIU = defineCachedEventHandler(async (event) => {
...
const _mk8FBk = lazyEventHandler(() => {
...
const _lazy_oNqOnv = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_oNqOnv, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _qxbQIU, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _mk8FBk, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_oNqOnv, lazy: true, middleware: false, method: undefined }
];
